...
source /home/zxc/Documents/work/kly_db/autoBackUp/hc_kly_db_live_2023-11-20_06_05.sql
...
mysqldump hc_kly_db > work/hc_kly_db_ali_1128.sql -u root -p

mysqldump hc_kly_db > autoBackUp/hc_kly_db_local_1011.sql -u root -p

mysqldump hc_kly_db > Downloads/hc_kly_db_local_1122.sql -u root -p
...
update system_info set remark = 1000 where status_name = 'NodeRewardGenesisPercentage';
update system_info set remark = 3000 where status_name = 'NodeRewardEcologyPercentage';
update system_info set remark = 6000 where status_name = 'NodeRewardProjectPercentage';
update system_info set remark = '4000,2000,1000,800,700,300,300,300,300,300' where status_name = 'bigRewardno';
update system_info set remark = '500,500,2000,4000,1000,2000' where status_name = 'usdtReceiver';
update system_info set remark = '3000,2500,4500,0,0' where status_name = 'klnReceiver';
...
update system_info set remark = '1' where status_name = 'transactionSwitch';
update user_info set level = 0, enter_Level = 0;
update system_info set status_value = '0' where status_name = 'smallRewardStatus';
...
git@github.com:tomatouiui/kly_db.git
git@github.com:tomatouiui/KleinSwapAdmWeb.git
git@github.com:tomatouiui/KleinSwapBackend.git
git@github.com:tomatouiui/KleinSwapAdminSite.git
